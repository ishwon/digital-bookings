        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-2 gap-6">
            <div>
              ...
              <div class="mt-2">
                <input type="number" name="vat_number" id="vat_number" value="{{ old('vat_number') }}"
        ...
        <div class="space-y-6">
          ...
          <div class="grid grid-cols-2 gap-6">
            <div>
              ...
              <div class="mt-2">
                <input type="number" name="commission_amount" id="commission_amount" value="{{ old('commission_amount') }}" min="0"
